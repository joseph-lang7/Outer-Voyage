...
const Footer = () => {
  return (
    <footer className="bg-blue-500 h-auto max-w-screen flex flex-col md:flex-row justify-center gap-4 md:gap-[50px] p-8">
      <div className="max-w-[500px]">
        <div>
          ...
          <div className="flex gap-3 mt-2">
            <div className="hover:text-white duration-300 hover:scale-150 cursor-pointer">
      ...
      <div>
        ...
        <div>
          <ul>
            <Link href="/">
              <li className="hover:text-white duration-300 hover:ml-2">
                About
              </li>
            </Link>
            <Link href="/">
      ...
      <div className="w-56">
        ...
        <div>
          <ul>
            ...
            <li className="w-full flex gap-1 items-center hover:text-white duration-300 hover:ml-2 cursor-pointer">
              {" "}
